...
> as default, read|write permissions
...
- generated when a job starts and lasts until the job finishes

[GitHub Actions - default permission](https://docs.github.com/en/actions/security-guides/automatic-token-authentication#permissions-for-the-github_token)
